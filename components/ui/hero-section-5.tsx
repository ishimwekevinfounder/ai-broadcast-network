                    ...
                    <div className="py-24 md:pb-32 lg:pb-36 lg:pt-72">
                        <div className="relative z-10 mx-auto flex max-w-7xl flex-col px-6 lg:block lg:px-12">
                            <div className="mx-auto max-w-lg text-center lg:ml-0 lg:max-w-full lg:text-left">
                                <h1 className="mt-8 max-w-2xl text-balance text-5xl md:text-6xl lg:mt-16 xl:text-7xl">Build 10x Faster with AI Broadcast Network</h1>
                        ...
                        <div className="aspect-[2/3] absolute inset-1 overflow-hidden rounded-3xl border border-black/10 sm:aspect-video lg:rounded-[3rem] dark:border-white/5">
                            <video
                                ...
                                src="https://ik.imagekit.io/lrigu76hy/AI-BROADCAST-NETWORK/dna-video.mp4?updatedAt=1745736251477"></video>
                        </div>
                    </div>
                </section>
...
const Logo = ({ className }: { className?: string }) => {
    return (
        <div className={cn("flex items-center gap-2", className)}>
            ...
            <span className="text-lg font-bold tracking-tight">AI-BROADCAST-NETWORK</span>
        </div>
    )
}
